...
const AddCCTV = () => {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      // Log the request URL
      console.log('Sending update request to:', `${ApiUrl}/updatecctv/${editingProduct.id}`);
  
      // Send the update request
      const response = await axios.put(`${ApiUrl}/updatecctv/${editingProduct.id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
    ...
    <div className="laptops-page">
      <div className="laptops-content">
        ...
        <div className="laptops-product-image">
          <img
            src={`${ApiUrl}/uploads/cctv/${product.prod_img}`} 
