...
const CCTVAd = () => {
  ...
  const handleAddProduct = async (type) => {
    ...
    try {
      ...
      const productsResponse = await axios.get(`${ApiUrl}/fetchcctvofferspage`);
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const fetchResponse = await axios.get(`${ApiUrl}/fetchcctvofferspage`);
      ...
      if (result.isConfirmed) {
        try {
          ...
          if (response.ok) {
            ...
            const updatedResponse = await axios.get(`${ApiUrl}/fetchcctvofferspage`);
