...
const productStatus = userRole === "Admin" ? "approved" : "unapproved";
  ...
  const handleUpdateProduct = async () => {
    ...
    console.log("Sending update request to:", `${ApiUrl}/updatesecondhandproducts/${editingProduct.id}`);
  ...
  return (
    <div className="laptops-page">
      <div className="laptops-content">
        <h2 className="laptops-page-title">Add Refurbished Products (Second hand products)</h2>
            ...
            products.map((product, index) => (
              <div className="laptops-product-card">
                ...
                <div className="laptops-product-details">
                  <h3 className="laptops-product-name">{product.prod_name} {product.productStatus === 'unapproved' ? <span style={{color:'red'}}>({product.productStatus})</span> : null}</h3>                  <h3 className="laptops-product-subtitle">
                    {product.subtitle}
                  </h3>
