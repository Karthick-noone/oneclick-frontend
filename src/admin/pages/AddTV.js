...
const AddTeleVision = () => {
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      // Log the request URL
      console.log('Sending update request to:', `${ApiUrl}/updatetv/${editingProduct.id}`);
  
      // Send the update request
      const response = await axios.put(`${ApiUrl}/updatetv/${editingProduct.id}`, formData, {
        headers: {
          'Content-Type': 'multipart/form-data'
        }
      });
  ...
  return (
    <div className="laptops-page">
      <div className="laptops-content">
        <h2 className="laptops-page-title">Add TeleVision </h2>
        ...
        <div className="laptops-product-image">
          <img
            src={`${ApiUrl}/uploads/tv/${product.prod_img}`} 
