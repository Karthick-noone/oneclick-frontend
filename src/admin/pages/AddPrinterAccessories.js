...
const PrinterAccessories = () => {
  ...
  const handleImageUpdate = () => {
    ...
    if (selectedFile) {
      ...
      fetch(
        `${ApiUrl}/updateprinteraccessories/image/${productId}?index=${imageIndex}`,
        {
          method: "PUT",
          body: formData,
        }
  ...
  const handleDeleteImage = (productId, imageIndex) => {
    ...
    Swal.fire({
      ...
      if (result.isConfirmed) {
        ...
        fetch(
          `${ApiUrl}/deleteprinteraccessories/image/${productId}?index=${imageIndex}`,
          {
            method: "DELETE",
          }
        )
  ...
  if (!hasDigit) {
    ...
    try {
      ...
      const fetchResponse = await axios.get(
        `${ApiUrl}/fetchprinteraccessories`
      );
    ...
    if (confirmResult.isConfirmed) {
      try {
        ...
        console.log(
          ...
          `${ApiUrl}/deleteprinteraccessories/${id}`
        );
