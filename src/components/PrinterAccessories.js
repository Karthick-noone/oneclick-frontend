...
const PrinterAccessories = () => {
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (cacheRef.current.printeraccessories) {
          ...
          setCoupons(cacheRef.current.printeraccessoriesCoupons);
          setLoading(false);
          return;
        }
        ...
        cacheRef.current.printeraccessories = fetchedProducts;
        ...
        cacheRef.current.printeraccessoriesCoupons = couponMap;
      } catch (error) {
  ...
  const category = "printeraccessories";
