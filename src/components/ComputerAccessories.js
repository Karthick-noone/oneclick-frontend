...
useEffect(() => {
  const fetchProducts = async () => {
    ...
    if (cacheRef.current.computeraccessories) {
      setProducts(cacheRef.current.computeraccessories);
    } else {
    ...
    try {
      ...
      cacheRef.current.computeraccessories = fetchedProducts; // Update cache
    } catch (error) {
...
useEffect(() => {
  ...
  // const category = "computeraccessories";
