  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (cacheRef.speakers) {
          setProducts(cacheRef.speakers);
          setCoupons(cacheRef.headphoneCoupons);
          setLoading(false);
          return;
        }
        ...
        cacheRef.speakers = fetchedProducts;
        ...
        cacheRef.headphoneCoupons = couponMap;
      } catch (error) {
