 ...
 wishlistData.push(product);
  ...
  return (
    <div className="computers-page">
      ...
      {/* <Header3 /> */}
      <span style={{ marginLeft: "20px",padding:'10px' }}><a style={{textDecoration:'none', color:'black'}} href="/">Home </a> &gt; Watches</span>
    ...
    <p>
      In the meantime, please select a different category to continue shopping.
    </p>
  </div>
