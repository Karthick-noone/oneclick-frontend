    ...
    <div style={styles.pageContainer}>
      ...
      <div style={styles.container}>
        <div style={styles.textContainer}>
          ...
          <h4 style={styles.subtitle}>Collection of Your Information  </h4>
          <p style={styles.paragraph}>
          ...
          <p style={styles.paragraph}>
          If you enroll into our loyalty and membership program, such SuperCoin, VIP or similar programs offered by Oneclick, we will collect and store your personal data such as name, contact number, email address, communication address, date of birth, gender, zip code, lifestyle information, demographic and work details which is provided by you to Oneclick or a third-party business partner that operates online/offline establishments or platforms where you can earn loyalty points for purchase of goods and services, and redeem loyalty points. We will also collect your information related to your transactions on Oneclick platform and such third-party business partner platforms. When such a third-party business partner collects your personal data directly from you, you will be governed by their privacy policies. Additionally, we collect your UPI ID if you choose to pay via our Oneclick UPI platform. Oneclick shall not be responsible for the third-party business partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
          </p>
          <p style={styles.paragraph}>
          Oneclick has onboarded certain third-party business partners on the Platform who specialize in the categories like travel ticket reservations, booking online movie tickets, paying online bills and more (Ultra-Partners). If you use the services of Ultra-Partners, you will be redirected to Ultra-Partners websites/applications and your entry to Ultra-Partners websites/applications will be based on your Oneclick login credentials after seeking your permissions to share the data further. Oneclick shall not be responsible for the Ultra-Partner’s privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
          </p>
          <h4 style={styles.subtitle}>Use of Demographic / Profile Data / Your Information
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Cookies</h4>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Sharing of personal data</h4>
          <p style={styles.paragraph}>
          We may share personal data internally within Oneclick group companies including Oneclick Advanz Private Limited, Scapic Innovations Private Limited, and other Oneclick affiliates, related companies and third parties, including Credit Bureaus and business partners (such as UPI platform), for purposes of providing products and services offered by them, such as, personal loans offered by Scapic Innovations Private Limited through its lending partners, insurance, the deferred payment options, Oneclick PayLater offered by Oneclick Advanz Private Limited through its lending partners. These entities and affiliates may share such information with their affiliates, business partners and other third parties for the purpose of conducting the required checks, namely for the purpose of credit underwriting, providing you their products and services and may market to you as a result of such sharing unless you explicitly opt-out.
          </p>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Links to Other Sites</h4>
          <p style={styles.paragraph}>
          Our Platform may provide links to other websites or applications that may collect personal data about you and you will be governed by their privacy policies. Oneclick shall not be responsible for the privacy practices or the content of their privacy policies, and we request you to read their privacy policies prior to disclosing any information.
          </p>
          <h4  id="PaymentMethod" style={styles.subtitle}>Security Precautions</h4>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Choice/Opt-Out</h4>
          <p style={styles.paragraph}>
          We provide all users with the opportunity to opt-out of receiving non-essential (promotional, marketing-related) communications after setting up an account with us. If you do not wish to receive promotional communications from us, then please login into the Notification Preference page of Platform [https://https://oneclickteck.com/communication-preferences/email] to unsubscribe/opt-out.
          </p>
          <h4  id="PaymentMethod" style={styles.subtitle}>Advertisements on Platform</h4>
          <p style={styles.paragraph}>
          We use third-party advertising companies to serve ads when you visit our Platform. These companies may use information (not including your name, address, email address, or telephone number) about your visits to this and other websites in order to provide personalized advertisements about goods and services of interest to you. You have an option to opt out from tracking of personalized advertising using the “Opt out of Ads Personalization” settings using your device’s settings application. Oneclick will have no access to your GAID once you select this feature.
          </p>
          <h4  id="PaymentMethod" style={styles.subtitle}>Children Information</h4>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Your Consent</h4>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Changes to this Privacy Policy</h4>
          <p style={styles.paragraph}>
          ...
          <h4  id="PaymentMethod" style={styles.subtitle}>Grievance Officer</h4>
          <p style={styles.paragraph}>
          In accordance with Information Technology Act 2000 and rules made there under, the name and contact details of the Grievance Officer are provided below:
          </p>
          <ul style={styles.list}>
            <li style={styles.listItem}>AJIL S</li>
            <li style={styles.listItem}>Designation: Founder</li>
            {/* <li style={styles.listItem}>Embassy tech village</li> */}
            <li style={styles.listItem}>Market Road,</li>
            <li style={styles.listItem}>Marthandam,</li>
            <li style={styles.listItem}>Kanyakumari District,</li>
            <li style={styles.listItem}>TamilNadu, India, 629165.</li>
            <li style={styles.listItem}>Email: enquiryoneclick@gmail.com</li>
          </ul>

          <h4  id="PaymentMethod" style={styles.subtitle}>Customer Support</h4>
          <p style={styles.paragraph}>
