...
useEffect(() => {
  const fetchProducts = async () => {
    ...
    try {
      ...
      if (cacheRef.mobileaccessories) {
        setProducts(cacheRef.mobileaccessories);
        setCoupons(cacheRef.mobileaccessoriesCoupons);
        setLoading(false);
        return;
      }
      ...
      cacheRef.mobileaccessories = fetchedProducts;
      ...
      cacheRef.mobileaccessoriesCoupons = couponMap;
    } catch (error) {
