...
const SignupPage = () => {
  ...
  const validateForm = () => {
    ...
    } else if (!/^[6-9]\d{9}$/.test(contactNumber)) { // Validate the contact number format
      newErrors.contactNumber = "Contact number must be a valid 10-digit number starting with 6-9";
    }
  ...
  try {
    ...
    if (response.ok) {
      ...
      if (data.error === "Email already exists") {
        ...
        errorMessage = "The contact number is already in use. Please use a different number.";
      }
...
<div style={styles.background}>
    ...
    <div style={styles.container}>
      ...
      <form style={styles.form} onSubmit={handleSubmit}>
        ...
        <label style={styles.label}  htmlFor="name">Email</label>
        ...
        <input
          type="text"
          name="contactNumber" // Add contact number field
        ...
        <label style={styles.label}  htmlFor="name">Confirm Password</label>
...
const styles = {
  ...
  container: {
    maxWidth: "400px", // Make the card smaller in width
    width:'400px',
    margin: "30px auto", // Reduce margin from the top
    padding: "15px", // Decrease padding to make it more compact
    borderRadius: "10px",
